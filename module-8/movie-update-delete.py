...
cursor = db.cursor()
cursor.execute(
    "INSERT into film (film_id, film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id) VALUES ('4', 'Star Wars', '1977', '121', 'George Lucas', '1', '2')")
...
cursor = db.cursor()
cursor.execute(
    "UPDATE film SET film_id = '2', film_name = 'Alien', film_releaseDate = '1979', film_runtime = '117', film_director = 'Ridley Scott', studio_id = '1', genre_id = '1' WHERE film_name = 'Alien'")
movies = cursor.fetchall()
